...
object HandlingFailure extends App{
  ...
  val potenialFailure = Try(unsafeMethod())
  println(potenialFailure) // does not crash
  ...
  // utilities
  println(potenialFailure.isSuccess)
  ...
  class Connection {
    def get(url: String): String = {
      ...
      if (random.nextBoolean()) "<html>...</htmn>"
